...
type ComplexityRoot struct {
	Mutation struct {
		...
		RemoveTodo  func(childComplexity int, id string) int
		SetTodoDone func(childComplexity int, id string, done *bool) int
	}
	...
	TodoEvent struct {
		EvType func(childComplexity int) int
...
type MutationResolver interface {
	...
	RemoveTodo(ctx context.Context, id string) (*model.Todo, error)
	SetTodoDone(ctx context.Context, id string, done *bool) (*model.Todo, error)
}
type QueryResolver interface {
	Todos(ctx context.Context) ([]*model.Todo, error)
}
type SubscriptionResolver interface {
	TodoChanges(ctx context.Context) (<-chan *model.TodoEvent, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.removeTodo":
		...
		return e.complexity.Mutation.RemoveTodo(childComplexity, args["id"].(string)), true

	case "Mutation.setTodoDone":
		if e.complexity.Mutation.SetTodoDone == nil {
			break
		}

		args, err := ec.field_Mutation_setTodoDone_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.SetTodoDone(childComplexity, args["id"].(string), args["done"].(*bool)), true
	...
	case "TodoEvent.evType":
		if e.complexity.TodoEvent.EvType == nil {
			break
		}

		return e.complexity.TodoEvent.EvType(childComplexity), true
...
func (ec *executionContext) field_Mutation_setTodoDone_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["id"]; ok {
...
func (ec *executionContext) _Mutation_removeTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().RemoveTodo(rctx, args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_setTodoDone(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().SetTodoDone(rctx, args["id"].(string), args["done"].(*bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Subscription_todoChanges(ctx context.Context, field graphql.CollectedField) (ret func() graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = nil
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Subscription().TodoChanges(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return nil
	...
	return func() graphql.Marshaler {
		res, ok := <-resTmp.(<-chan *model.TodoEvent)
		if !ok {
			return nil
		}
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "setTodoDone":
			out.Values[i] = ec._Mutation_setTodoDone(ctx, field)
		default:
...
func (ec *executionContext) _TodoEvent(ctx context.Context, sel ast.SelectionSet, obj *model.TodoEvent) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "evType":
			out.Values[i] = ec._TodoEvent_evType(ctx, field, obj)
		case "todo":
